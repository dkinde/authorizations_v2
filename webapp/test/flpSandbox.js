					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Berechtigung DVZ",
									"targetURL": "#authorization-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"authorization-display": {
								...
								"action": "display",
								"description": "Authorization App for DVZ",
								"title": "Berechtigung DVZ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=authorization",
									"url": sap.ui.require.toUrl("authorization")
								}
							}
						}
					}
