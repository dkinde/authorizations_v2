sap.ui.define([
   ...
   return Controller.extend("authorization.controller.HAUFW001", {
        ...
        onCreatePress: function () {
			...
			oNewEntry.typ      = this.getView().byId("__inputCRUD1").getValue();
        ...
        createValidation: function () {
			...
			if (iInput1.length < 3 && iInput1.length > 0 && isNaN(sInput3) && sInput3.length < 60 && isNaN(sInput4) && sInput4.length < 60 && isNaN(sInput2) && sInput2.length < 2) {
        ...
        editValidation: function () {
            ...
            // validation all inputs - next button
            if (iInput1.length < 4 && iInput1.length > 0 && isNaN(sInput3) && sInput3.length < 61 && isNaN(sInput4) && sInput4.length < 61 && isNaN(sInput2) && sInput2.length < 3) {
        ...
        onUpdateEditPress: function () {
			...
			oUpdateEntry.typ      = this.getView().byId("__editCRUD1").getValue();
